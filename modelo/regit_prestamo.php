<?php
    ...
    class regit_prestamo extends datos{
        ...
        function guardar(){
            ...
            $r = " GUARDADO ";
            if($b){
                $r = "EL LIBRO NO SE ENCUENTRA";
            }else{
                $e = $this->Ejecuta("insert into prestamos (codigo,
                                                            nombre_rol,
                                                            cedula_usuario,
                                                            nombre_usuario,
                                                            estado_usuario,
        ...
        function buscar(){
            ...
            if($b){
                ...
                $bu = $this->Busca("Select * from usuario where cedula_usuario = '$this->cedula_usuario'");
                $re = "";
                if($bu){
                    $this->set_nombre_rol($bu[0][1]);
                    $this->set_cedula_usuario($bu[0][2]);
                    $this->set_nombre_usuario($bu[0][3]);
                    $this->set_estado_usuario($bu[0][4]);
                }
                else{
                    $re = "EL USUARIO NO SE ENCUENTRA REGISTRADO";
                }
        ...
        function mostrar(){
            $m = $this->Busca("select * from prestamos");
            return $m;
        }
